...
import parts.body.wavesurfing.EnemyWave;

public class WaveSurfing extends Part {

	public WaveSurfing() {
		this.version = "1.0";
		this.type = "body";
		this.status = "Basic WaveSurfing from tutorial";
	}
    ...
    @SuppressWarnings("rawtypes")
	public ArrayList _enemyWaves, _surfDirections, _surfAbsBearings;

    public static double _oppEnergy = 100.0;

	/**
	 * This is a rectangle that represents an 800x600 battle field, used for a
	 * simple, iterative WallSmoothing method (by PEZ). If you're not familiar with
	 * WallSmoothing, the wall stick indicates the amount of space we try to always
	 * have on either end of the tank (extending straight out the front or back)
	 * before touching a wall.
	 */
